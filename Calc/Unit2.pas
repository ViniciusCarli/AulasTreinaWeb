...
procedure TForm2.Button2Click(Sender: TObject);  //SUBTRAÇÃO
var
  Num1, Num2, Resultado : Integer;
begin
  Num1 := SpinEdit1.Value;
...
procedure TForm2.Button3Click(Sender: TObject);  //MULTIPLICAÇÃO
var
  Num1, Num2, Resultado : Integer;
begin
  Num1 := SpinEdit1.Value;
...
procedure TForm2.Button4Click(Sender: TObject); //DIVISÃO
var
...
procedure TForm2.Button5Click(Sender: TObject);  //DIVISÃO REAL
var
