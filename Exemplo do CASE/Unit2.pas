...
begin
  Filhos := SpinEdit1.Value;
    case filhos of
      0: ShowMessage('O usuario não possui filhos');
...
begin
  ...
  case Letra of
    ...
    ' '  :  ShowMessage('O usuario Não Digitou.'); //Feito de forma zoada
    else
      ShowMessage('O usuario não digitou nenhumas das letras esperadas(A,B,C,D e E)');
